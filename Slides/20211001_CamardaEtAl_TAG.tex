...
\begin{frame}[fragile]\frametitle{Data and aim}
	\vspace{-0.2cm}
\begin{itemize}
	\item Death and exposures by 
	\begin{itemize}
		\item five years age-group: 0-4, 5-9, $\ldots$, 85+
		\item females and males separately 
	\end{itemize}	
	\item 2019 data source (baseline):
	\begin{itemize}
		\item Mortality and Global Health Estimates (GHE)
		\item Data available for all 194 populations
	\end{itemize}
	\item 2020 data sources:
	\begin{itemize}
		\item ???
		\item Data available for only 60 populations
	\end{itemize}
	\item Information provided by William et al.
	\begin{itemize}
...
\begin{frame}[fragile]\frametitle{The two approaches}
	...
	\end{enumerate}
\item Final common step: redistribution of estimated 2020 deaths to match ``known'' overall excess mortality deaths
	 \end{itemize}	
...
\begin{frame}[fragile]\frametitle{Clusters}
	...
	\only<2>{
		\begin{scriptsize}
			\begin{table}[]
				\begin{tabular}{clrrr}
					Cluster                                            & \multicolumn{1}{c}{pop w/ data}                                                                           & \multicolumn{1}{l}{\begin{tabular}[c]{@{}l@{}}\# pop \\ w/ data\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}\# pop \\ w/o data\end{tabular}} & \multicolumn{1}{l}{$\frac{\mbox{\# w/o data}}{\mbox{\# w/data}}$} \\ \hline
					\rowcolor[HTML]{C0C0C0} 
					1                                                  & \begin{tabular}[c]{@{}l@{}}CYP,DNK,EST,FIN,ISL,\\ JPN,KOR,LUX,NOR\end{tabular}                            & 9                                                                             & 4                                                                              & 0.44                                                              \\
					2                                                  & \begin{tabular}[c]{@{}l@{}}ALB,AND,BEL,BGR,CZE,\\ ESP,ITA,LTU,MDA,POL,ROU,\\ RUS,SRB,SVN,USA\end{tabular} & 15                                                                            & 4                                                                              & 0.27                                                              \\
					\rowcolor[HTML]{C0C0C0} 
					3                                                  & BRA,IRQ,ZAF,COL                                                                                           & 4                                                                             & 65                                                                             & 16.25                                                             \\
					4                                                  & \begin{tabular}[c]{@{}l@{}}AUT,CHE,CHL,FRA,GBR,\\ GEO,HRV,HUN,MNE,NLD,\\ PRT,SVK,SWE,UKR\end{tabular}     & 14                                                                            & 0                                                                              & 0.00                                                              \\
					\rowcolor[HTML]{C0C0C0} 
					5                                                  & CAN,DEU,GRC,LVA,MLT                                                                                       & 5                                                                             & 1                                                                              & 0.20                                                              \\
					6                                                  & CRI,ISR,PRY,TUN                                                                                           & 4                                                                             & 51                                                                             & 12.75                                                             \\
					\rowcolor[HTML]{C0C0C0} 
					7                                                  & AUS,IRL,MUS,NZL,URY                                                                                       & 5                                                                             & 7                                                                              & 1.40                                                              \\
					8                                                  & ARM,ECU,MEX,PER                                                                                           & 4                                                                             & 2                                                                              & 0.50                                                              \\ \hline
					\rowcolor[HTML]{C0C0C0} 
					\multicolumn{1}{l}{\cellcolor[HTML]{C0C0C0}\textbf{Totals}} &                                                                                                           & 60                                                                            & 134                                                                            & 2.23                                                             
				\end{tabular}
			\end{table}
\end{scriptsize}
}
