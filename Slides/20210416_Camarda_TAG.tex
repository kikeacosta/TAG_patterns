...
\title[Modelling Covid-19 Mortality Age-pattern$\qquad$]
{\LARGE{A tentative model for \\Covid-19 Mortality Age-pattern}} 
...
\date[Apr 2021]{
$\,$\\$\,$\\ \textsl{TAG Working Group I, Meeting II}\\
$\,$\\
\vspace{0.1cm}
\footnotesize{April 16th, 2021}} % (optional) 
...
\begin{frame}[fragile]\frametitle{Data and methods}
	\vspace{-0.2cm}
\begin{itemize}
	\item Data:
	\begin{itemize}
		\item a subset of COVerAGE-DB with 100+ deaths, both sexes%: 60 populations
		\item Europe (24), Africa (7), Asia (12), Latin America (13), North-America (3), Oceania (1)
		\item scaled to JHU total on Dec 31, 2020
	\end{itemize}
\bigskip
	\item Modelling options:
	
	\medskip
%\begin{center}
	{\color{Red}\textsl{PCLM}}: Population-specific smooth age-pattern
%	\end{center}
\begin{itemize}
		\gooditem[\textbf{+}] relatively good fit
		\pooritem[\textbf{--}] useless for populations with no detailed data
\end{itemize}
\medskip
%\begin{center}
	{\color{Blue}\textsl{PH-PCLM}}: Region-specific smooth age-pattern + \\$\quad\,\qquad\qquad$population-specific scaling factor
%\end{center}
\begin{itemize}
	\pooritem[\textbf{--}] inevitable mixture of different age-patterns
			\gooditem[\textbf{+}] applicable to populations with no detailed data
\end{itemize}

%		\begin{}
%			content...
%		\end{}
%		\item[\hspace{2cm}]: Population-specific smooth age-pattern
%		\begin{itemize}
%			\gooditem[\textbf{+}] relatively good fit
%			\pooritem[\textbf{--}] useless for populations with no detailed data
%		\end{itemize}
%	\medskip
%		\item[{\color{Blue}\textsl{Smooth PH}}]: Region-specific smooth age-pattern + \\population-specific scaling factor
%		\begin{itemize}
%			\pooritem[\textbf{--}] inevitable mixture of different age-patterns
%			\gooditem[\textbf{+}] applicable to populations with no detailed data
%		\end{itemize}
...
\bigskip
	...
	\begin{itemize}
		\item Coarse and country-specific age-groups {\color{Green}\checkmark}
		\item Data quality (coverage issues, age-heaping, $\ldots$)
	\end{itemize}
\end{itemize}
...
\begin{frame}[fragile]\frametitle{An illustrative example: Asian populations}
	\vspace{-0.5cm}
	\only<1>{
		\begin{center}
			\includegraphics[scale=.3]{Figures/AsiaIndiv.pdf}
		\end{center}
	\vspace{-0.3cm}
	\centering Treating each population independently
	}
	\only<2>{
		\begin{center}
			\includegraphics[scale=.3]{Figures/AsiaIndivFIT.pdf}
		\end{center}
		\vspace{-0.3cm}
	\centering Treating each population independently
	}
	\only<3>{
		\begin{center}
			\includegraphics[scale=.3]{Figures/AsiaRegion.pdf}
		\end{center}
	\vspace{-0.3cm}
	\centering Region-specific pattern + population-specific scaling factor
	}
\only<4>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/AsiaRegionFIT.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Region-specific pattern + population-specific scaling factor
}
\only<5>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/AsiaIndivRegion.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Both approaches: {\color{Red}\textsl{PCLM}} vs.~{\color{Blue}\textsl{PH-PCLM}}
}
\end{frame}


\begin{frame}[fragile]\frametitle{Other regions: \only<1>{Europe}\only<2>{Africa}\only<3>{Latin America}\only<4>{North America}}
	\vspace{-0.5cm}
	\only<1>{
		\begin{center}
			\includegraphics[scale=.3]{Figures/EuropeIndivRegion.pdf}
		\end{center}
		\vspace{-0.3cm}
		\centering Both approaches: {\color{Red}\textsl{PCLM}} vs.~{\color{Blue}\textsl{PH-PCLM}}
	}
	\only<2>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/AfricaIndivRegion.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Both approaches: {\color{Red}\textsl{PCLM}} vs.~{\color{Blue}\textsl{PH-PCLM}}
}
	\only<3>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/LatinAmericaIndivRegion.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Both approaches: {\color{Red}\textsl{PCLM}} vs.~{\color{Blue}\textsl{PH-PCLM}}
}
	\only<4>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/NorthAmericaIndivRegion.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Both approaches: {\color{Red}\textsl{PCLM}} vs.~{\color{Blue}\textsl{PH-PCLM}}
}
...
\begin{frame}[fragile]\frametitle{All data}
	\vspace{-0.5cm}
	\only<1>{
		\begin{center}
			\includegraphics[scale=.3]{Figures/WorldIndiv.pdf}
		\end{center}
		\vspace{-0.3cm}
		\centering {\color{Red}\textsl{PCLM}}
	}
	\only<2>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/WorldRegion.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering {\color{Blue}\textsl{PH-PCLM}}
}
	\only<3>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/WorldROA.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering {\color{Blue}\textsl{PH-PCLM}}
}
\only<4>{
	\begin{center}
		\includegraphics[scale=.3]{Figures/WorldROAdiff.pdf}
	\end{center}
	\vspace{-0.3cm}
	\centering Rate of aging: {\color{Red}\textsl{PCLM}} (from regional mean) vs.~{\color{Blue}\textsl{PH-PCLM}}
}
\end{frame}
