\documentclass[table,xcdraw,dvipsnames,handout]{beamer}
...
\begin{frame}[fragile]\frametitle{A schematic illustration}
	\vspace{-0.2cm}
\only<1>{
		\begin{center}
...
\end{frame}
\begin{frame}[fragile]\frametitle{A schematic illustration: a relative risk perspective}
	\vspace{-0.2cm}
	\only<5>{
		\begin{center}
			\includegraphics[scale=.26]{Figures/SimulEta3.pdf}
